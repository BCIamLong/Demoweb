...
<section class="pages cart-page section-padding anh">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="table-responsive padding60 "style="border-radius:50px ;">
		...
		<div class="row margin-top">
			<div class="col-sm-6">
				<div class="single-cart-form padding60 "style="border-radius:50px ;">
					<div class="log-title">
