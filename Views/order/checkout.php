...
.nen{
 background:url('public/img/nenshop4.jpg') no-repeat;
 min-height: 50vh;
...
<section class="pages checkout section-padding anh">
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				<div class="main-input single-cart-form padding60 " style="border-radius: 50px;">
					<div class="log-title">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="padding60 "style="border-radius: 50px;">
					<div class="log-title">
					...
					<div class="cart-form-text pay-details table-responsive">
						...
						<tr>
							...
							<tfoot>
								<tr >
									<th style="color:black">Tổng</th>
									<td style="color:black"><?= number_format($count + 15000) ?> VNĐ</td>
								</tr>
							</tfoot>
						</table>
					</div>
