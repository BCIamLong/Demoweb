<style type="text/css">
    .pages-title {
        background:url("public/img/anhbia1.jpg") repeat;
}
.nen{
 background:url('public/img/nenshop2.jpg') no-repeat;
 min-height: 50vh;
...
<?php if ($data != null) { ?>
    ...
    <div class="product-details pages section-padding-top nen">
        <div class="container">
            <div class="row" >
                <div class="single-list-view"style="width:1200px;">
                    <div class="col-xs-12 col-sm-5 col-md-4"style="width:400px;">
                        <div class="quick-image"style="width:400px;">
                            <div class="single-quick-image text-center">
                                <div class="list-img" >
                                    <div class="product-f tab-content" style="width: 390px;height: 400px;">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8">
                        <div class="quick-right">
                            <div class="list-text">
                                ...
                                <?php if ($data['MaDM'] == 1||$data['MaDM'] == 2||$data['MaDM'] == 3) { ?>
                                    <p><?= $data['MoTa'] ?></p>
                                <?php }?>
                                <div class="list-btn">
                ...
                <div class="col-xs-12">
                    <div class="reviews padding60 margin-top">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="tb">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div><?= $data['KhoiLuong'] ?></div>
                                            </li>
                                            <li>
                                                <span>Số Lượng</span>
                                                <div><?= $data['SoLuongCo'] ?></div>
                                            </li>
                                            <li>
                                                <span>Thành Phần</span>
                                                <div><?= $data['ThanhPhan'] ?></div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <span>Bảo Quản</span>
                                                <div><?= $data['BaoQuan'] ?></div>
                                            </li>
                                            <li>
                                                <span>Thương Hiệu</span>
                                                <div><?= $data['ThuongHieu'] ?></div>
                                            </li>
                                            <li>
                            ...
                            <?php } ?>
                            <div class="<?php if ($data['MaDM'] == 1||$data['MaDM'] == 2||$data['MaDM'] == 3) {
