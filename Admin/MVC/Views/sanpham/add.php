<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
  ...
  <form action="?mod=sanpham&act=store" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="" placeholder="" name="LSP">
    </div>
    <div class="form-group">
      <label for="">Nơi sản xuất</label>
      <input type="text" class="form-control" id="" placeholder="" name="NoiSX">
    </div>
    <div class="form-group">
      <label for="">Thương hiệu</label>
      <input type="text" class="form-control" id="" placeholder="" name="ThuongHieu">
    </div>
    <div class="form-group">
      <label for="">Khối lượng</label>
      <input type="text" class="form-control" id="" placeholder="" name="KhoiLuong">
    </div>
    <div class="form-group">
      <label for="">Số lượng</label>
      <input type="text" class="form-control" id="" placeholder="" name="SoLuongCo">
    </div>
    <div class="form-group">
      <label for="">Thành phần</label>
      <input type="text" class="form-control" id="" placeholder="" name="ThanhPhan">
    </div>
    <div class="form-group">
      <label for="">Bảo quản</label>
      <input type="text" class="form-control" id="" placeholder="" name="BaoQuan">
    </div>
    <div class="form-group">
      <label for="">Cách sử dụng</label>
      <input type="text" class="form-control" id="" placeholder="" name="CachSD">
    </div>
